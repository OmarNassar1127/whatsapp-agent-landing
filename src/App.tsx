...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white animated-gradient relative overflow-hidden">
            ...
            <div className="prose prose-invert prose-sm max-w-none space-y-4 text-gray-300">
              {lang === 'nl' ? (
                <>
                  ...
                  <p>Voor vragen: <a href="mailto:omarnassar1127@gmail.com" className="text-emerald-400 hover:underline">omarnassar1127@gmail.com</a></p>
                </>
              ) : (
                <>
                  ...
                  <h3 className="text-lg font-semibold text-white mt-6">5. Contact</h3>
                  <p>For questions: <a href="mailto:omarnassar1127@gmail.com" className="text-emerald-400 hover:underline">omarnassar1127@gmail.com</a></p>
                </>
              )}
            </div>
          </div>
            ...
            <div className="prose prose-invert prose-sm max-w-none space-y-4 text-gray-300">
              {lang === 'nl' ? (
                <>
                  ...
                  <p><a href="mailto:omarnassar1127@gmail.com" className="text-emerald-400 hover:underline">omarnassar1127@gmail.com</a></p>
                </>
              ) : (
                <>
                  <p><strong>Last updated:</strong> January 30, 2026</p>
      ...
      <nav className="fixed top-0 w-full z-50 px-4 py-4">
        <div className={`max-w-6xl mx-auto rounded-2xl px-4 md:px-6 py-3 flex justify-between items-center transition-all duration-300 ${scrolled ? 'bg-black/95 backdrop-blur-xl shadow-lg shadow-black/50 border border-white/10' : 'liquid-glass'}`}>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <a href="mailto:omarnassar1127@gmail.com" className="px-4 py-2 rounded-xl liquid-glass font-medium hover:bg-white/10 transition flex items-center gap-2">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-2 mx-auto max-w-6xl liquid-glass rounded-2xl p-4 space-y-2">
            ...
            <a href="mailto:omarnassar1127@gmail.com" className="flex items-center gap-2 px-4 py-3 rounded-xl hover:bg-white/10 transition">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              {t.nav.emailUs}
        ...
        <div className="max-w-xl mx-auto">
          <div className="liquid-glass-strong rounded-2xl p-6 md:p-8 text-center">
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              ...
              <a href="mailto:omarnassar1127@gmail.com" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl liquid-glass font-medium hover:bg-white/10 transition">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                {t.contact.sendEmail}
      ...
      <a href={`https://wa.me/3168783813?text=${whatsappMessage}`} target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 w-14 h-14 md:w-16 md:h-16 rounded-full whatsapp-gradient flex items-center justify-center shadow-lg shadow-emerald-500/30 hover:scale-110 transition-transform glow-green">
          ...
          <div className="liquid-glass rounded-xl py-6 px-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-sm">
                ...
                <a href="mailto:omarnassar1127@gmail.com" className="text-white hover:text-emerald-400 transition">{t.footer.contact}</a>
              </div>
