...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white animated-gradient relative overflow-hidden">
      ...
      <section className="py-16 md:py-20 px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-gray-400">Bedrijven die al tijd besparen met ZapBot</p>
          </div>
            ...
            {[
              {
                ...
                role: "Eigenaar, Salon Fatima",
                text: "Ik was eerst sceptisch, maar nu kan ik niet meer zonder. Klanten krijgen direct antwoord en ik mis geen afspraken meer. Scheelt me uren per week!",
                avatar: "👩‍🦱"
              },
              {
                name: "Pieter de Vries",
                role: "Restaurant De Smulhoek",
                text: "Reserveringen gaan nu helemaal automatisch. Zelfs 's nachts worden boekingen aangenomen. Onze no-shows zijn met 40% gedaald door de herinneringen.",
                avatar: "👨‍🍳"
              },
              {
                name: "Deniz Yilmaz",
                role: "Barbershop The Cut",
                text: "Mijn klanten denken dat ik de hele dag op m'n telefoon zit, maar het is gewoon de AI. Super persoonlijk en altijd in mijn stijl. Aanrader!",
                avatar: "💈"
              }
            ].map((testimonial, i) => (
      ...
      <a
        href="https://wa.me/3168783813?text=Hoi!%20Ik%20heb%20interesse%20in%20ZapBot%20%F0%9F%91%8B"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 md:w-16 md:h-16 rounded-full whatsapp-gradient flex items-center justify-center shadow-lg shadow-emerald-500/30 hover:scale-110 transition-transform glow-green"
      >
