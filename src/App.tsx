    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <nav className="fixed top-0 w-full z-50 bg-gray-950/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <a 
            href="#contact" 
            className="px-4 py-2 rounded-lg whatsapp-gradient font-medium hover:opacity-90 transition"
          >
            Demo aanvragen
          </a>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="#contact" 
                className="px-8 py-4 rounded-xl whatsapp-gradient font-semibold text-lg hover:opacity-90 transition shadow-lg shadow-emerald-500/20"
              >
                Gratis demo bekijken
              </a>
              <a 
                href="#how-it-works" 
                className="px-8 py-4 rounded-xl bg-gray-800 font-semibold text-lg hover:bg-gray-700 transition border border-gray-700"
              >
                Hoe werkt het?
              </a>
            </div>
          ...
          <div className="mt-16 max-w-md mx-auto">
            <div className="bg-gray-900 rounded-3xl p-4 border border-gray-800 shadow-2xl">
              <div className="bg-emerald-800 rounded-2xl p-4 space-y-3">
                {/* Chat bubble - customer */}
                <div className="flex justify-end">
                  <div className="bg-emerald-600 rounded-2xl rounded-br-md px-4 py-2 max-w-[80%]">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-wrap justify-center items-center gap-8 text-gray-400">
            ...
            <div className="flex items-center gap-8">
              <span className="font-semibold text-white">Kappers</span>
              <span className="font-semibold text-white">Restaurants</span>
              <span className="font-semibold text-white">Tandartsen</span>
              <span className="font-semibold text-white">Fysiotherapeuten</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800 hover:border-emerald-500/50 transition">
              <div className="w-12 h-12 rounded-xl whatsapp-gradient flex items-center justify-center mb-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-gray-800/50 rounded-xl p-6 text-center border border-gray-700 hover:border-emerald-500/50 transition">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-lg mx-auto">
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl p-8 border border-emerald-500/30 shadow-xl shadow-emerald-500/10">
              <div className="text-center">
                ...
                <p className="text-gray-400 mb-6">+ €500 eenmalige setup (normaal €1000)</p>
              </div>
              ...
              <a 
                href="#contact" 
                className="block w-full py-4 rounded-xl whatsapp-gradient font-semibold text-center hover:opacity-90 transition"
              >
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 px-4 py-4 rounded-xl bg-gray-800 border border-gray-700 focus:border-emerald-500 focus:outline-none transition"
              />
              <button
                type="submit"
                className="px-8 py-4 rounded-xl whatsapp-gradient font-semibold hover:opacity-90 transition whitespace-nowrap"
              >
                Demo aanvragen
              </button>
            </form>
