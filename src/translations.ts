...
export const translations = {
  nl: {
    ...
    calendarIntegration: {
      ...
      point2Desc: 'De AI ziet exact welke tijden vrij zijn. Per tijdslot één klant of meerdere? Jij kiest, de AI regelt het.',
  ...
  en: {
    ...
    calendarIntegration: {
      ...
      point2Desc: 'The AI sees exactly which times are free. One customer per slot or multiple? You choose, the AI handles it.',
